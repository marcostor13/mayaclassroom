...
const ICONS: Record<string, string> = {
  ...
  image: '<rect x="3" y="3.5" width="18" height="17" rx="4"/><circle cx="8.8" cy="9.3" r="1.9"/><path d="m3.4 17.3 4.4-4.05a2 2 0 0 1 2.65-.05l3.15 2.7a2 2 0 0 0 2.7-.07l2.4-2.28a2 2 0 0 1 2.7-.03l3.2 2.88"/>',
